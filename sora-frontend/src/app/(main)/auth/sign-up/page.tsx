...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await stackClientApp.signUpWithCredential({ email, password });
      // Refresh the router to update server-side user state
      router.refresh();
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="text-center text-sm text-gray-600">
            <p>
              ...
              <Link href="/handler/sign-up" className="font-medium text-emerald-600 hover:text-emerald-500">
